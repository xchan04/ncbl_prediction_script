...
| 2 | **League spreadsheet** — a downloaded `.xlsx`/`.csv`, **or a shareable sheet link** (Google Sheets URL / shortener / direct file URL) | `--input` | Standings, predictions, threats, ranking report, videos |
